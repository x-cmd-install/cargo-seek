...
[![x-cmd/install — cargo-seek Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/cargo-seek.svg?lang=zh)](https://x-cmd.com/install/cargo-seek)
...
合计: **6,748** 行代码（覆盖前 5 种语言、共 **46** 个文件）。
...
- **上游仓库**: <https://github.com/tareqimbasher/cargo-seek>
- **官网**: <https://crates.io/crates/cargo-seek>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.2.0` (2026-07-08)
- **最近提交**: 2026-07-08
- **Release 含资产**: 6 个

## 流行度

- **Star**: 200 · **Fork**: 2 · **开放 issue**: 9 · **贡献者**: 2

## 累计统计

- **发布数**: 2 · **已合并 PR**: 2 · **开放 PR**: 1 · **已关闭 issue**: 4 · **开放 issue**: 5 · **提交数**: 104
...
| last60d | 2026-07-26 | 0 | 0 | 1 | 0 | 4 | 0 |
| 90d | 2026-06-26 | 1 | 0 | 1 | 0 | 4 | 9 |
| last180d | 2026-03-28 | 1 | 0 | 1 | 0 | 4 | 31 |
| 360d | 2025-09-29 | 1 | 0 | 1 | 0 | 4 | 36 |
| last720d | 2024-10-04 | 2 | 2 | 1 | 4 | 5 | 92 |
...
cargo-seek 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `cargo-seek` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/cargo-seek.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T03:49:42Z._
